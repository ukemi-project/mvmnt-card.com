...
<section id="error" class="flex items-stretch h-full bg-mcblack">
  <div
    class="container flex flex-col items-center self-center justify-center flex-1 px-5 mx-auto md:flex-row md:max-w-screen-md">
    <div
      class="flex flex-col items-center text-center md:mb-16 lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 md:items-start md:text-left">
      <h1 class="mb-4 text-5xl font-bold text-mcwhite title-font sm:text-4xl">
        Error: {status}
      </h1>
      <p class="mb-8 text-mcwhite">{error.message}</p>
      <div class="flex">
